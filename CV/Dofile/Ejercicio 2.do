...
local base_in_2   = ".\Entrega\Data\Usu_hogar_T319.txt"
local base_in_1   = ".\Entrega\Data\Usu_individual_T319.txt"
local base_out	  =	".\Entrega\Data\eph_q32019.dta"
...
use ".\Entrega\Data\eph_q32019.dta", clear
...
export excel ".\Entrega\Resultados\inciso_c.xls", firstrow(variables) sheet("2019",replace)

restore


*Realizo el mismo procedimiento pero para el 2023
use ".\Entrega\Data\eph_q32023.dta", clear
...
export excel ".\Entrega\Resultados\inciso_c.xls", firstrow(variables) sheet("2023",replace)
