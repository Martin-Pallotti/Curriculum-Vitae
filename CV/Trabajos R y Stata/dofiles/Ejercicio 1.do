...
*Importo la base
import excel using ".\data\EDU-2019-4229-EN-T008.xlsx", sheet("Table II.B1.3.1") cellrange(A14:S96) firstrow clear
...
import excel using ".\data\Data_WB.xlsx", sheet("Data") cellrange(A1:E21) firstrow clear
